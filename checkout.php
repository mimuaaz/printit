...
$tot=$_GET['tot'];
$stmt = $admin -> ret("SELECT COUNT(*) FROM `cart` WHERE `c_id` = '$uid' ");
    ...
    <div class="site-section">
      <div class="container">
        ...
        <div class="row">
            ...
            <div class="p-3 p-lg-5 border">
              ...
              <div class="form-group row">
                <div class="col-md-6">
                  ...
                  <input type="text" class="form-control" id="c_fname" name="name" placeholder="Full name" required="">
                </div>
                <div class="col-md-6">
                  <label for="c_lname" class="text-black">Email <span class="text-danger">*</span></label>
                  <input type="email" class="form-control" id="c_lname" name="email" placeholder="Email" required="">
                </div>
              </div>
              ...
              <div class="form-group row">
                <div class="col-md-12">
                  ...
                  <input type="text" class="form-control" id="c_companyname" name="phone" placeholder="Phone no" required="">
                </div>
              </div>
              ...
              <div class="form-group row">
                ...
                <div class="col-md-6">
                  <label for="c_postal_zip" class="text-black" required="">City <span class="text-danger">*</span></label>
                  <input type="text" class="form-control" id="c_postal_zip" name="city" placeholder="City" required="">
                </div>
              </div>
              ...
              <div class="form-group row mb-5">
                <div class="col-md-6">
                  ...
                  <input type="text" class="form-control" id="c_email_address" name="state" placeholder="State" required="">
                </div>
                <div class="col-md-6">
                  <label for="c_phone" class="text-black">Pincode <span class="text-danger">*</span></label>
                  <input type="text" class="form-control" id="c_phone" name="pincode" placeholder="Pincode" required="">
                </div>
              </div>
              ...
              <div class="col-md-12">
                ...
                <div class="p-3 p-lg-5 border">
                  <table class="table site-block-order-table mb-5">
                    ...
                    <tbody>
                      <tr>
                        <td>Cart <strong class="mx-2"></strong> </td>
          ...
          ?>
                      <tr>
                        <td><?php echo $arow['pro_name']; ?> <strong class="mx-2"></strong>   </td>
                        <td>Rs <?php echo $arow['price']; ?></td>
                     ...
                     <?php } ?>
                      <tr>
                        ...
                        <td class="text-black font-weight-bold"><strong>Rs<?php echo $tot ?></strong></td>
                      </tr>
                    </tbody>
                  </table>
