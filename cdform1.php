          ...
          <div class="col-md-9 order-1">
            ...
            <?php 
              ...
              <div class="col-lg-6 col-md-6 item-entry mb-4">
                ...
                <a href="cdform.php?id=<?php echo $row['p_id']?>" class="product-item md-height bg-gray d-block">
                  <img src="admin/controller/<?php echo $row['image']?>" alt="Image" class="img-fluid">
                </a>
                <h2 class="item-title"><a href="cdform.php?id=<?php echo $row['p_id']?>"><?php echo $row['pro_name']?></a></h2>
                <strong class="item-price"><i class="fa fa-rupee"></i><?php echo $row['price']?></strong>
                <a href="cdform.php?id=<?php echo $row['p_id']?>" style="margin-left:50px" class="btn btn-primary">Customize</a>
              </div>
                 <?php }?>
             </div>
